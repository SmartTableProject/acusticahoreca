...
export default function ChiSiamoPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16">
      ...
      <h1 className="mt-2 text-4xl font-bold text-nrs-dark">{site.name}</h1>
      ...
      <div className="mt-10 max-w-3xl space-y-6 text-lg leading-relaxed text-stone-700">
        ...
        <p className="border-l-2 border-nrs-dark pl-5 text-base text-stone-600">
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          >
            <p className="text-lg font-bold text-nrs-dark">{stat.value}</p>
